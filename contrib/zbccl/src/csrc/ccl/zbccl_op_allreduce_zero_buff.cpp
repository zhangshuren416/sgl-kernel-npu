...
#include "aclrtlaunch_ShmemZeroBuffAllReduce.h"
...
constexpr uint32_t BLOCK_NUM_LARGE_DATA = 24;

namespace zbccl {
ZBCCL_API int ZcclAllReduceZeroBuff(uint8_t *inp, uint8_t *out, size_t inpNumel, ZCCLDataType dataType,
                                    int teamId, aclrtStream stream, uint32_t reduceOp)
{
    ...
    ACLRT_LAUNCH_KERNEL(ShmemZeroBuffAllReduce)(blockDim, stream, inp, out, (uint8_t *)ptr,
