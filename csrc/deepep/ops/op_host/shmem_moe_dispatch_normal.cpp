...
namespace ops {
class ShmemMoeDispatchNormal : public OpDef
{
public:
    explicit ShmemMoeDispatchNormal(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->Attr("shmem_ptr").AttrType(REQUIRED).Int();
